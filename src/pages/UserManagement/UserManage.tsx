...
export default function UserManage({ users, reload, loading }: Props) {
    ...
    <>
      <div className="mb-6 flex items-start justify-between">
        <div className="invisible" aria-hidden>
          <h2 className="text-[28px]">User</h2>
        </div>
          ...
          <>
                        ...
                        <TooltipProvider delayDuration={150}>
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <Tooltip>
                              ...
                              <TooltipContent side="top" className="bg-gray-900 text-white text-[11px] px-2 py-1">Edit User</TooltipContent>
                            </Tooltip>
                            <Tooltip>
                              <TooltipTrigger asChild>
                            ...
                            <Tooltip>
                              ...
                              <TooltipContent side="top" className="bg-gray-900 text-white text-[11px] px-2 py-1">Delete User</TooltipContent>
                            </Tooltip>
                          </div>
                        </TooltipProvider>
                      </TableCell>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-between mt-6">
                <p className="text-[13px] text-gray-600">Showing {((currentPage - 1) * itemsPerPage) + 1} to {Math.min(currentPage * itemsPerPage, filteredUsers.length)} of {filteredUsers.length} users</p>
      ...
      <Dialog open={isAddUserDialogOpen} onOpenChange={setIsAddUserDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle className="text-[20px]">Add New User</DialogTitle>
          ...
          <DialogFooter>
            ...
            <Button className="bg-[#317752] hover:bg-[#2a6545] text-white rounded-[10px]" onClick={() => { toast.success("New user has been created successfully!"); setIsAddUserDialogOpen(false); }}>Create User</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isViewUserDialogOpen} onOpenChange={setIsViewUserDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle className="text-[20px]">User Details</DialogTitle>
            ...
            <div className="py-4">
              <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-200">
                ...
                <div>
                  ...
                  <Badge className="bg-purple-100 text-purple-700 border-0 text-[11px]">User</Badge>
                </div>
              </div>
          ...
          <DialogFooter>
            ...
            <Button className="bg-[#317752] hover:bg-[#2a6545] text-white rounded-[10px]" onClick={() => { setIsViewUserDialogOpen(false); if (selectedUser) handleEditUser(selectedUser); }}>Edit User</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          ...
          <div className="mt-2 w-full flex items-center justify-end gap-3">
            ...
            <button type="button" className="rounded-[10px] h-10 px-5 bg-red-600 hover:bg-red-700 text-white" onClick={confirmDelete}>Delete User</button>
          </div>
        </DialogContent>
      </Dialog>
    </>
